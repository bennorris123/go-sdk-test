...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Chat.NewCompletion(context.Background(), relaxaitest.ChatNewCompletionParams{
	...
	if userAgent != fmt.Sprintf("RelaxaiTest/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Chat.NewCompletion(context.Background(), relaxaitest.ChatNewCompletionParams{
		Messages: []relaxaitest.ChatCompletionMessageParam{{
			MultiContent: []relaxaitest.ChatCompletionMessageMultiContentParam{{}},
			Role:         "role",
		}},
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Chat.NewCompletion(cancelCtx, relaxaitest.ChatNewCompletionParams{
		Messages: []relaxaitest.ChatCompletionMessageParam{{
			MultiContent: []relaxaitest.ChatCompletionMessageMultiContentParam{{}},
			Role:         "role",
		}},
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Chat.NewCompletion(deadlineCtx, relaxaitest.ChatNewCompletionParams{
			Messages: []relaxaitest.ChatCompletionMessageParam{{
				MultiContent: []relaxaitest.ChatCompletionMessageMultiContentParam{{}},
				Role:         "role",
			}},
